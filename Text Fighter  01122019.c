...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, hypsp3 = 0, wnctrecA = 0, prntcor = 0, dubon = 0;
...
if ((posdef > 0) && (torwnrt < 100) && (torwnrt > 9) && (wnrtrec == 100) && (cpuwn2 < 2))
printf("     Tournament Win Rate:  %.2f%%", torwnrt);
if ((posdef > 0) && (torwnrt < 100) && (torwnrt > 9) && (wnrtrec < 100) && (wnrtrec > 9) && (cpuwn2 < 2))
printf("     Tournament Win Rate: %.2f%%", torwnrt);
if ((posdef > 0) && (torwnrt < 100) && (torwnrt < 10) && (wnrtrec < 100) && (wnrtrec < 10) && (cpuwn2 < 2))
printf("     Tournament Win Rate: %.2f%%", torwnrt);
if ((posdef > 0) && (torwnrt < 100) && (torwnrt < 10) && (wnrtrec < 100) && (wnrtrec > 9) && (cpuwn2 < 2))
printf("     Tournament Win Rate:  %.2f%%", torwnrt);
if ((posdef > 0) && (torwnrt == 100) && (cpuwn2 < 2))
printf("     Tournament Win Rate: %.2f%%", torwnrt);
if ((posdef > 0) && (torwnrt < 1) && (wnrtrec < 1) && (cpuwn2 > 1))
printf("     Tournament Win Rate: %.2f%%", torwnrt);
if (((posdef > 0) && (torwnrt > 9) && (wnrtrec3 > 9) && (cpuwn2 > 1)) || ((posdef > 0) && (torwnrt > 0) && (torwnrt < 10) && (wnrtrec3 < 10) && (cpuwn2 > 1)))
printf("     Tournament Win Rate: %.2f%%", torwnrt);
if ((posdef > 0) && (torwnrt > 9) && (wnrtrec3 < 10) && (cpuwn2 > 1))
printf("     Tournament Win Rate: %.2f%%", torwnrt);
Sleep(300);
...
{
Sleep (300);
if ((torwnrt > 0) && (posdef > 0) && (torwnrt != 100) && (wnrtrec == 100))
printf("\n     Tournament Win High: %.2f%%", wnrtrec);
if (((torwnrt > 0) && (posdef > 0) && (torwnrt == 100)) || ((torwnrt > 0) && (posdef > 0) && (torwnrt <= 99) && (wnrtrec <= 99) && (wnrtrec3 > 9)))
printf("\n     Tournament Win High: %.2f%%", wnrtrec);
if ((torwnrt > 0) && (posdef > 0) && (torwnrt != 100) && (wnrtrec > 0) && (wnrtrec3 < 10))
printf("\n     Tournament Win High: %.2f%%", wnrtrec);
}
}
if (cpuwn2 > 0)
...
if (cpuwn2 > 0)
{
if ((cpuwn2 >= 1) && (torwnrt > wnrt) && (wnrtrec > wnrtrec3) && (wnrtrec3 < torwnrt) && (prntcor == 0))
{
printf("\n     ");
++prntcor;
++a;
...
if ((a > 0) && (b < 1) && (cpuwn2 <= 1) && (torwnrt > 0))
printf("Tournament Win Low:   %.2f%%\n", wnrtrec3);
if ((a > 0) && (b < 1) && (cpuwn2 <= 1) && (torwnrt < 1))
printf("Tournament Win Low:  %.2f%%\n", wnrtrec3);
if ((a > 0) && (b < 1) && (cpuwn2 > 1) && (wnrtrec3 < 10) && (torwnrt > 9))
printf("Tournament Win Low:   %.2f%%\n", wnrtrec3);
if ((a > 0) && (b < 1) && (cpuwn2 > 1) && (wnrtrec3 < 10) && (torwnrt < 10))
printf("Tournament Win Low:  %.2f%%\n", wnrtrec3);
if ((a > 0) && (b < 1) && (cpuwn2 > 1) && (wnrtrec3 > 9))
printf("Tournament Win Low:  %.2f%%\n", wnrtrec3);
if ((a < 1) && (b > 0) && (wnrtrec3 < 10))
printf("Tournament Win Low:  %.2f%%\n", wnrtrec3);
if ((a < 1) && (b > 0) && (wnrtrec3 > 9))
printf("Tournament Win Low: %.2f%%\n", wnrtrec3);
prntcor = 0;
a = 0;
b = 0;
...
if (((ctr < 9) && (cpusp > 1) && (new6 < 1)) || ((ctr > 8) &&  (cpusp < 2) && (new6 > 0))  || ((ctr > 8) &&  (cpusp > 1) && (new6 < 1)) || ((ctr < 9) &&  (cpusp < 2) && (new6 < 1)))
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
if (((ctr < 9) &&  (cpusp < 2) && (new6 > 0)) || ((ctr > 8) &&  (cpusp > 1) && (new6 < 1)) || ((ctr < 9) &&  (cpusp < 2) && (new6 < 1)) || ((ctr > 8) &&  (cpusp < 2) && (new6 > 0)) || ((ctr > 8) &&  (cpusp < 2) && (new6 < 1)) || ((ctr < 9) && (cpusp > 1) && (new6 < 1)))
printf("     How did you do that?\n");//edited, error, ! instead of ?, 09112019
if  ((ctr > 8) && (cpusp < 2) && (new6 < 1))
...
if (((ctr > 8) && (cpusp > 1) && (new6 > 0)) || ((ctr < 9) &&  (cpusp < 2) && (new6 > 0)))
printf("     That was totally awesome!\n");
if ((cpusp > 1) && (ctr < 9) && (new6 > 0))
printf("     You have entered the Text Fighter Hall of Fame!\n");
if (((ctr < 9) && (cpusp < 2)) || ((new6 < 1) && (cpusp > 1) && (ctr > 8)))
printf("     A phenomenal finish!\n");
if  ((ctr > 8) && (cpusp < 2) && (new6 < 1))
printf("\n     You're a Text Fighting genius!\n\n");
if (((ctr < 9) && (cpusp < 2)) || ((ctr < 9) && (new6 < 1) && (cpusp > 1)) || ((ctr < 9) && (new6 > 0) && (cpusp > 1)))
printf("\n");
if (((cpusp > 1) && (ctr > 8) && (new6 < 1)) || ((ctr > 8) && (new6 > 0) && (cpusp > 1)) || ((ctr > 8) && (new6 > 0) && (cpusp < 2)))
printf("\n");
if (((ctr < 9) &&  (cpusp < 2) && (new6 > 0)) || ((ctr < 9) && (new6 < 1) && (cpusp > 1)))
printf("     You are the King of Text Fighters!\n\n");
if ((((ctr < 9) && (ctr > 6)) && (cpusp > 1) && (new6 > 0)) || ((ctr > 8) && (new6 > 0) && (cpusp > 1)))
printf("     This is what it means to be a Text Fighting Master!\n\n");
...
if (((cpusp < 2) && (ctr > 5) && (new6 > 0)) || ((cpusp < 2) && (ctr < 6) && (new6 < 1)) || ((cpusp > 1) && (ctr > 5) && (new6 < 1)) || ((cpusp > 1) && (ctr < 6) && (new6 < 1)))
printf("\n");
if (new6 > 0)
printf("     And an impressive finish!\n");
if (((cpusp > 1) && (ctr < 6) && (new6 > 0)) || ((cpusp < 2) && (ctr < 6) && (new6 > 0)) || ((cpusp > 1) && (ctr > 5) && (new6 > 0)))
printf("\n");
if (ctr < 6)
...
if (((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((cpusp < 2) && (ctr < 6) && (new6 < 1)))
printf("\n     It was a good fight!\n\n");
if (((new6 < 1) && (ctr > 5) && (cpusp > 1)) || ((new6 > 0) && (ctr > 5) && (cpusp < 2)) || ((cpusp < 2) && (ctr < 6) && (new6 > 0)))
printf("\n     Amazing skill!\n\n");
if (((new6 < 1) && (ctr < 6) && (cpusp > 1)) || ((new6 > 0) && (ctr > 5) && (cpusp > 1)))
...
if (((new6 < 1) && (ctr > 7) && (cpusp > 1)) || ((new6 < 1) && (ctr > 7) && (cpusp < 2)))
printf("\n");
if (ctr < 6)
printf("     The fight finished early!\n");
if ((ctr < 8) && (ctr > 5))
printf("     That came out of nowhere!\n");
if (((new6 < 1)  && (cpusp < 2) && (ctr < 8)) || ((new6 < 1) && (cpusp > 1) && (ctr < 8)))
printf("\n");
if (new6 > 0)
printf("\n     You have a new Consecutive Match Win Record!\n");
if (cpusp > 1)
...
if (((new6 < 1) && (cpusp > 1) && (ctr < 8)) ||  ((new6 < 1)  && (cpusp < 2) && (ctr < 8)) || ((new6 < 1)  && (cpusp < 2) && (ctr > 7)))
...
if ((new6 < 1) && (cpusp > 1) && (ctr > 7))
printf("\n");
if (((new6 > 0) && (cpusp < 2) && (ctr > 7)) || ((new6 < 1) && (cpusp > 1) && (ctr > 7)))
...
if (((cpusp < 2) && (ctr < 10) && (new6 > 0)) || ((cpusp < 2) && (ctr < 10) && (new6 < 1)) || ((cpusp < 2) && (ctr > 9) && (new6 > 0)) || ((ctr > 9) && (cpusp > 1) && (new6 > 0)))
printf("\n");
if (((ctr < 10) && (new6 > 0) && (cpusp > 1)) || ((ctr > 9) && (new6 < 1) && (cpusp > 1)) || ((ctr < 10) && (new6 < 1) && (cpusp > 1)))
printf("\n");
if (ctr < 7)
...
if (((ctr < 10) && (cpusp > 1) && (new6 < 1)) || ((ctr > 9) && (cpusp < 2) && (new6 < 1)))
printf("\n");
if (new6 > 0)
printf("     You demonstrated amazing form!\n");
if (((cpusp < 2) && (ctr < 10) && (new6 > 0)) || ((cpusp < 2) && (ctr > 9) && (new6 > 0)) || ((cpusp > 1) && (ctr < 10) && (new6 > 0)))
printf("\n");
if (new6 > 0)
printf("     You've got a new Consecutive Match Win Record!\n");
if ((cpusp > 1) && (ctr > 9) && (new6 > 0))
...
printf("\n");
if (((ctr > 9) && (cpusp > 1) &&  (new6 < 0)) || ((ctr > 9) && (new6 > 0) && (cpusp < 2)) || ((ctr > 9) && (new6 < 1) && (cpusp > 1)))
printf("     Unstoppable magic tactics!\n\n");
if (((ctr < 10) && (cpusp < 2) && (new6 < 1)) || ((ctr < 10) && (new6 > 0) && (cpusp < 2)) || ((ctr > 9) && (new6 < 1) && (cpusp < 2)))
printf("     Hyper magic skill!\n\n");
if (((ctr < 10) && (cpusp > 1) && (new6 < 1)) ||  ((ctr > 9) && (new6 > 0) && (cpusp > 1)))
...
if (((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((cpusp < 2) && (ctr < 6) && (new6 < 1)))
printf("\n     Great move!\n\n");
if (((new6 < 1) && (ctr > 5) && (cpusp > 1)) || ((new6 > 0) && (ctr > 5) && (cpusp < 2)) || ((new6 > 0) && (ctr < 6) && (cpusp < 2)))
printf("\n     Good skill!\n\n");
if (((new6 < 1) && (ctr < 6) && (cpusp > 1)) || ((new6 > 0) && (ctr > 5) && (cpusp > 1)))
...
diceQ = (rand() % 4) + 1;/// Edited 29112019
if (diceQ == 1)
...
printf("     It was a fantastic bout!\n");
if (((cpusp < 2) && (ctr > 7) && (new6 < 1)) || ((cpusp > 1) && (ctr > 7) && (new6 < 1)) || ((cpusp < 2) && (ctr < 8) && (new6 < 1)))
printf("\n     That was really magnificent!\n\n");
if (((cpusp > 1) && (ctr < 8) && (new6 < 1)) || ((cpusp < 2) && (ctr > 7) && (new6 > 0)))
printf("\n     That was completely outstanding!\n\n");
if ((cpusp > 1) && (ctr > 7) && (new6 > 0))
...
{
enemyhp = (enemyhp - 14 * dmg2); //was 11 12
...
if (diceQ == 4)
printf("     Great technique!\n");
if (((cpusp > 1) && (ctr > 5) && (new6 > 0)) || ((cpusp > 1) && (ctr < 6) && (new6 < 1)) || ((cpusp < 2) && (ctr > 5) && (new6 > 0)) || ((cpusp < 2) && (ctr < 6) && (new6 < 1)))
printf("\n");
...
if (((cpusp < 2) && (ctr > 5) && (new6 < 1)) || ((cpusp > 1) && (ctr > 5) && (new6 < 1)) || ((cpusp < 2) && (ctr < 6) && (new6 < 1)))
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
if (((cpusp > 1) && (ctr < 6) && (new6 < 1)) || ((cpusp < 2) && (ctr > 5) && (new6 > 0)))
printf("\n     It was a sensational fight!\n\n");
if (((cpusp > 1) && (ctr > 5) && (new6 > 0)) || ((cpusp < 2) && (ctr < 6) && (new6 > 0)))
...
if (diceQ == 1)
printf("     It's a superb victory!\n");
if (diceQ == 2)
printf("     It was a spectacular fight!\n");
if (diceQ == 3)
printf("     It's a thrilling victory!\n");
if (diceQ == 4)
printf("     It was an excellent fight!\n");
if ((ctr < 7) && (ctr > 5))
printf("     That was an incredibly skillful move!\n");
if (ctr < 6)
printf("     The contest ended early!\n");
...
if (((new6 < 1) && (ctr > 6) && (cpusp > 1)) || ((new6 < 1) && (ctr > 6) && (cpusp < 2)))
printf("\n");
if (ctr < 6)
printf("     The bout finished early!\n");
if ((ctr < 7) && (ctr > 5))
printf("     You didn't even break a sweat!\n");
if (((new6 < 1)  && (cpusp < 2) && (ctr < 7)) || ((new6 < 1)  && (cpusp > 1) && (ctr < 7)))
printf("\n");
if (new6 > 0)
printf("\n     You have a new Consecutive Match Win Record!\n");
if (cpusp > 1)
...
if (((new6 < 1) && (cpusp > 1) && (ctr < 7)) ||  ((new6 < 1)  && (cpusp < 2) && (ctr < 7)) || ((new6 < 1)  && (cpusp < 2) && (ctr > 6)))
...
if ((new6 < 1) && (cpusp > 1) && (ctr > 6))
printf("\n");
if (((new6 > 0) && (cpusp < 2) && (ctr > 6)) || ((new6 < 1) && (cpusp > 1) && (ctr > 6)))
...
{
playerhp = (playerhp - 10 * dmg2);//was 7
...
if (diceQ == 3)
printf("     THAT'S A STUNNING CPU WIN!\n\n");
}
spatt = 0;
hypsp = 0;
enspcomb2 = 0;
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     IT WAS A FANTASTIC CPU WIN!\n\n");
if (diceQ == 2)
...
if (diceQ == 2)
printf("     THE ULTIMATE MAGIC ROUTINE!\n\n");
if (diceQ == 3)
...
if (((diceQ > 9) && (diceQ1 < 12) && (diceQ1 > 1)) || ((diceQ1 > 1) && (diceQ1 < 12) && (diceQ == 5) && (ctr < 9)))
printf("\n");
if ((diceQ > 9) && (diceQ1 == 1) && (diceE <= 20) && (diceF <= 29) && (diceC <= 47) && (diceM <= 40))
printf("\n");
