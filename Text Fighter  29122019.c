...
if  ((ctr > 8) && (cpusp < 2) && (new6 < 1))
printf("     That was absolutely magnificent!\n");
if  ((ctr < 9) && (cpusp < 2) && (new6 < 1))
printf("     That was a brilliant technique!\n");
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("\n     THAT'S A SENSATIONAL CPU FINISH!\n\n");
if (diceQ == 2)
...
if (diceQ == 3)
printf("     AND A BRILLIANT CPU WIN!\n\n");
}
spatt = 0;
hypsp = 0;
enspcomb2 = 0;
